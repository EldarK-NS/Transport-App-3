...
export default function InfoDistanceBlock({ colorInfo, titleText, subtitleText, pointA_Title, pointA_Subtitle, pointA_date, pointB_Title, pointB_Subtitle, pointB_date, buttonTitle }) {
    return (
        <View style={styles.mainContainer}>
            {colorInfo ? <View style={styles.headerColorContainer}>
                <Text style={styles.infoColorText}>{colorInfo}</Text>
            </View> : null}
            {titleText ? <View style={styles.titleContainer}>
                <Text style={styles.titleText}>{titleText}</Text>
                <Text style={styles.subTitleText}>{subtitleText}</Text>
            </View> : null}
            {pointA_Title ? <View style={styles.middleContainer}>
            ...
            {buttonTitle ? <View style={styles.footerButtonContainer}>
